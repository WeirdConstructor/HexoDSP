...
API example for connecting the input:
`tseq(0).input().clock(&amp(1).output().sig())`
...
API example for connecting the input:
`tseq(0).input().trig(&amp(1).output().sig())`
...
API example for connecting the input:
`tslfo(0).input().time(&amp(1).output().sig())`
...
API example for connecting the input:
`tslfo(0).input().trig(&amp(1).output().sig())`
...
API example for connecting the input:
`tslfo(0).input().rev(&amp(1).output().sig())`
...
API example for connecting the input:
`mix3(0).input().ch1(&amp(1).output().sig())`
...
API example for connecting the input:
`mix3(0).input().ch2(&amp(1).output().sig())`
...
API example for connecting the input:
`mix3(0).input().ch3(&amp(1).output().sig())`
...
API example for connecting the input:
`mix3(0).input().vol1(&amp(1).output().sig())`
...
API example for connecting the input:
`mix3(0).input().vol2(&amp(1).output().sig())`
...
API example for connecting the input:
`mix3(0).input().vol3(&amp(1).output().sig())`
...
API example for connecting the input:
`mix3(0).input().ovol(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().slct(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().t_rst(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().t_up(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().t_down(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_1(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_2(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_3(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_4(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_5(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_6(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_7(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_8(&amp(1).output().sig())`
...
API example for connecting the input:
`mux9(0).input().in_9(&amp(1).output().sig())`
...
API example for connecting the input:
`allp(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`allp(0).input().time(&amp(1).output().sig())`
...
API example for connecting the input:
`allp(0).input().g(&amp(1).output().sig())`
...
API example for connecting the input:
`amp(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`amp(0).input().gain(&amp(1).output().sig())`
...
API example for connecting the input:
`amp(0).input().att(&amp(1).output().sig())`
...
API example for connecting the input:
`biqfilt(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`biqfilt(0).input().freq(&amp(1).output().sig())`
...
API example for connecting the input:
`biqfilt(0).input().q(&amp(1).output().sig())`
...
API example for connecting the input:
`biqfilt(0).input().gain(&amp(1).output().sig())`
...
API example for connecting the input:
`code(0).input().in1(&amp(1).output().sig())`
...
API example for connecting the input:
`code(0).input().in2(&amp(1).output().sig())`
...
API example for connecting the input:
`code(0).input().alpha(&amp(1).output().sig())`
...
API example for connecting the input:
`code(0).input().beta(&amp(1).output().sig())`
...
API example for connecting the input:
`code(0).input().delta(&amp(1).output().sig())`
...
API example for connecting the input:
`code(0).input().gamma(&amp(1).output().sig())`
...
API example for connecting the input:
`comb(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`comb(0).input().time(&amp(1).output().sig())`
...
API example for connecting the input:
`comb(0).input().g(&amp(1).output().sig())`
...
API example for connecting the input:
`delay(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`delay(0).input().trig(&amp(1).output().sig())`
...
API example for connecting the input:
`delay(0).input().time(&amp(1).output().sig())`
...
API example for connecting the input:
`delay(0).input().fb(&amp(1).output().sig())`
...
API example for connecting the input:
`delay(0).input().mix(&amp(1).output().sig())`
...
API example for connecting the input:
`fvafilt(0).input().freq(&amp(1).output().sig())`
...
API example for connecting the input:
`fvafilt(0).input().res(&amp(1).output().sig())`
...
API example for connecting the input:
`fvafilt(0).input().drive(&amp(1).output().sig())`
...
The left channel of the output signal.
 `pverb(0).output().sig_l()`
- output **sig_r**
The right channel of the output signal.
 `pverb(0).output().sig_r()`
#### NodeId::PVerb Help
...
API example for connecting the input:
`pverb(0).input().in_l(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().in_r(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().predly(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().size(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().dcy(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().ilpf(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().ihpf(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().dif(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().dmix(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().mspeed(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().mshp(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().mdepth(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().rlpf(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().rhpf(&amp(1).output().sig())`
...
API example for connecting the input:
`pverb(0).input().mix(&amp(1).output().sig())`
...
API example for connecting the input:
`rust1x1(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`rust1x1(0).input().alpha(&amp(1).output().sig())`
...
API example for connecting the input:
`rust1x1(0).input().beta(&amp(1).output().sig())`
...
API example for connecting the input:
`rust1x1(0).input().delta(&amp(1).output().sig())`
...
API example for connecting the input:
`rust1x1(0).input().gamma(&amp(1).output().sig())`
...
API example for connecting the input:
`sfilter(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`sfilter(0).input().freq(&amp(1).output().sig())`
...
API example for connecting the input:
`sfilter(0).input().res(&amp(1).output().sig())`
...
API example for connecting the input:
`cqnt(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`cqnt(0).input().oct(&amp(1).output().sig())`
...
API example for connecting the input:
`map(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`map(0).input().atv(&amp(1).output().sig())`
...
API example for connecting the input:
`map(0).input().offs(&amp(1).output().sig())`
...
API example for connecting the input:
`map(0).input().imin(&amp(1).output().sig())`
...
API example for connecting the input:
`map(0).input().imax(&amp(1).output().sig())`
...
API example for connecting the input:
`map(0).input().min(&amp(1).output().sig())`
...
API example for connecting the input:
`map(0).input().max(&amp(1).output().sig())`
...
API example for connecting the input:
`quant(0).input().freq(&amp(1).output().sig())`
...
API example for connecting the input:
`quant(0).input().oct(&amp(1).output().sig())`
...
API example for connecting the input:
`smap(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`smap(0).input().min(&amp(1).output().sig())`
...
API example for connecting the input:
`smap(0).input().max(&amp(1).output().sig())`
...
API example for connecting the input:
`exta(0).input().slew(&amp(1).output().sig())`
...
API example for connecting the input:
`exta(0).input().atv1(&amp(1).output().sig())`
...
API example for connecting the input:
`exta(0).input().atv2(&amp(1).output().sig())`
...
API example for connecting the input:
`exta(0).input().atv3(&amp(1).output().sig())`
...
API example for connecting the input:
`extb(0).input().slew(&amp(1).output().sig())`
...
API example for connecting the input:
`extb(0).input().atv1(&amp(1).output().sig())`
...
API example for connecting the input:
`extb(0).input().atv2(&amp(1).output().sig())`
...
API example for connecting the input:
`extb(0).input().atv3(&amp(1).output().sig())`
...
API example for connecting the input:
`extc(0).input().slew(&amp(1).output().sig())`
...
API example for connecting the input:
`extc(0).input().atv1(&amp(1).output().sig())`
...
API example for connecting the input:
`extc(0).input().atv2(&amp(1).output().sig())`
...
API example for connecting the input:
`extc(0).input().atv3(&amp(1).output().sig())`
...
API example for connecting the input:
`extd(0).input().slew(&amp(1).output().sig())`
...
API example for connecting the input:
`extd(0).input().atv1(&amp(1).output().sig())`
...
API example for connecting the input:
`extd(0).input().atv2(&amp(1).output().sig())`
...
API example for connecting the input:
`extd(0).input().atv3(&amp(1).output().sig())`
...
API example for connecting the input:
`exte(0).input().slew(&amp(1).output().sig())`
...
API example for connecting the input:
`exte(0).input().atv1(&amp(1).output().sig())`
...
API example for connecting the input:
`exte(0).input().atv2(&amp(1).output().sig())`
...
API example for connecting the input:
`exte(0).input().atv3(&amp(1).output().sig())`
...
API example for connecting the input:
`extf(0).input().slew(&amp(1).output().sig())`
...
API example for connecting the input:
`extf(0).input().atv1(&amp(1).output().sig())`
...
API example for connecting the input:
`extf(0).input().atv2(&amp(1).output().sig())`
...
API example for connecting the input:
`extf(0).input().atv3(&amp(1).output().sig())`
...
API example for connecting the input:
`fbrd(0).input().vol(&amp(1).output().sig())`
...
API example for connecting the input:
`fbwr(0).input().inp(&amp(1).output().sig())`
...
API example for connecting the input:
`inp(0).input().vol(&amp(1).output().sig())`
...
- output **sig1**
CC output channel 1
 `midicc(0).output().sig1()`
- output **sig2**
CC output channel 2
 `midicc(0).output().sig2()`
- output **sig3**
CC output channel 3
 `midicc(0).output().sig3()`
#### NodeId::MidiCC Help
**MIDI CC Input**
...
API example for connecting the input:
`midicc(0).input().slew(&amp(1).output().sig())`
...
API example for connecting the input:
`midip(0).input().det(&amp(1).output().sig())`
...
API example for connecting the input:
`midip(0).input().glen(&amp(1).output().sig())`
...
API example for connecting the input:
`out(0).input().ch1(&amp(1).output().sig())`
...
API example for connecting the input:
`out(0).input().ch2(&amp(1).output().sig())`
...
API example for connecting the input:
`out(0).input().vol(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().in1(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().in2(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().in3(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().time(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().trig(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().thrsh(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().off1(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().off2(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().off3(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().gain1(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().gain2(&amp(1).output().sig())`
...
API example for connecting the input:
`scope(0).input().gain3(&amp(1).output().sig())`
...
API example for connecting the input:
`test(0).input().f(&amp(1).output().sig())`
