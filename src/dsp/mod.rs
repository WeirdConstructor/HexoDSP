...
macro_rules! make_node_constructor {
    ($s1: ident => $v1: ident,
        ...
        pub struct ConstructorNode {
            node_id: NodeId,
            ops: Rc<RefCell<Vec<crate::dsp::ConstructorOp>>>,
        }
                ...
                for op in self.ops.borrow().iter() {
                    match op {
                        ...
                        ConstructorOp::Input(port, constr, output) => {
                            f.debug_struct(&node_id_str).field("output", output).field("input", constr).finish()?;
                        },
                        ConstructorOp::InputDefault(port, constr) => {
                            f.debug_struct(&node_id_str).field("input", constr).finish()?;
                        },
                        _ => {
                            writeln!(f, "   - {:?}", op)?;
                        }
        ...
        pub mod build {
            ...
            pub trait ConstructorNodeBuilder {
                ...
                fn build(&self) -> crate::dsp::ConstructorNode;
            }
            ...
            pub mod OutputPort {
                $(
                    #[derive(Debug, Clone)]
                    pub struct $variant {
                        pub node_id: super::super::NodeId,
                        pub node: crate::dsp::ConstructorNode,
                        pub port: Option<String>
                    }

                    impl super::ConstructorNodeOutputPort for $variant {
                        fn port(&self) -> (super::super::ConstructorNode, String) {
                            ...
                            pub fn $para(mut self, node: &dyn super::ConstructorNodeOutputPort) -> super::$variant {
                                ...
                                if portname.is_empty() {
                                    self.node.ops.borrow_mut().push(
                                        super::super::ConstructorOp::InputDefault(
                                            stringify!($para).to_string(), node));
                                } else {
                                    self.node.ops.borrow_mut().push(
                                        super::super::ConstructorOp::Input(
                    ...
                    impl $variant {
                        $(
                            pub fn $para(mut self, v: f32) -> super::$variant {
                                self.node.ops.borrow_mut().push(
                                    super::super::ConstructorOp::SetDenorm(
                        ...
                        $(
                            pub fn $atom(mut self, v: i32) -> super::$variant {
                                self.node.ops.borrow_mut().push(
                                    super::super::ConstructorOp::SetSetting(
            ...
            $(
                ...
                pub struct $variant {
                    ...
                    ops: Rc<RefCell<Vec<super::ConstructorOp>>>,
                }
                ...
                pub fn $str(instance: u8) -> crate::dsp::build::$variant {
                    $variant {
                        node_id: super::NodeId::$variant(instance),
